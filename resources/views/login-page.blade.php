            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Логін</h5>
                  ...
                  <form class="row g-3" action="{{ route('loginUser')}}" method="POST">
                    ...
                    <x-input-with-tag name="login" label="Логін" placeholder="Логін" bi="bi bi-box-arrow-in-right" value="{{ old('') }}"/>
                    ...
                    <div class="col-12">
                      <button class="btn btn-outline-warning w-100" type="submit">Розпочати</button>
                    </div>
                    <div class="col-12">
