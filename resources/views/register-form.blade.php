            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Нагадати пароль</h5>
                  ...
                  <form class="row g-3" action="{{ route('registerUser')}}" method="POST">
                    ...
                    <x-input-with-tag name="name" placeholder="Прізвище та ініціали (від 3 до 255)" bi="bi bi-person" autofocus="true" />
                    <x-input-with-tag name="login" label="Логін" placeholder="Логін (від 3 до 32)" bi="bi bi-box-arrow-in-right" />
                    <x-input-with-tag name="email" type="email" placeholder="Eлектрона пошта(від 4 до 255)" bi="bi bi-envelope-at" />
                    ...
                    <div class="col-12">
                      <button class="btn btn-outline-warning w-100" type="submit">Створити користувача</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Fogot an account? <a href="/forgot">Forgot</a></p>
                    </div>
                  </form>
